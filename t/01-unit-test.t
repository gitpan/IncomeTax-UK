...
$uk = IncomeTax::UK->new({age => 35, tax_year => '2010-11'}); 
is($uk->get_tax_amount(159000), "62272.50");

$uk = IncomeTax::UK->new({age => 35, tax_year => '2010-11'}); 
is($uk->get_tax_amount(55000), "19410.00");

$uk = IncomeTax::UK->new({age => 35, tax_year => '2010-11'}); 
is($uk->get_tax_amount(55000, 'other'), "19410.00");

$uk = IncomeTax::UK->new({age => 35, tax_year => '2010-11'}); 
is($uk->get_tax_amount(55000, 'dividend'), "15770.63");

$uk = IncomeTax::UK->new({age => 35, tax_year => '2010-11'}); 
is($uk->get_tax_amount(55000, 'savings'), "19410.00");